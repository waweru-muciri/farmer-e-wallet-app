...
const DepositInputForm = ({ navigation, userProfile,
  updateUserInfo, submitForm }) => {
        ...
        >
          ...
          <Button
            ...
            onPress={handleSubmit(async (data) => {
              const deposit_date = new Date().toLocaleDateString();
              const depositToSave = {
                ...data,
                deposit_date,
              };
              ...
              const SAVED_AMOUNT = parseFloat(data.amount);
              const TOTAL_AMOUNT_IN_ACCOUNT =
                CURRENT_AMOUNT_IN_ACCOUNT + SAVED_AMOUNT;
              ...
              try {
                await submitForm(depositToSave, "deposits");
...
export default connect(mapStateToProps, mapDispatchToProps)(DepositInputForm);
